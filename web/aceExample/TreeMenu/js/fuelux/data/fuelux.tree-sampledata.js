...
tree_data['vehicles']['additionalParameters']['children']['cars']['additionalParameters'] = {
	'children' : {
		...
		'trucks' : {name: 'Trucks', type: 'folder'}
	}
}

tree_data['vehicles']['additionalParameters']['children']['cars']['additionalParameters']['children']['trucks']['additionalParameters'] = {
		'children' : {
			'1' : {name: 'Classics', type: 'folder'},
			'2' : {name: 'Convertibles', type: 'item'},
			'3' : {name: 'Coupes', type: 'item'}
		}
	}
